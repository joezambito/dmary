...
/*
struct MaryChatMessage: Identifiable, Equatable {
    let id: UUID
    let timestamp: Date
    let text: String
    let isUser: Bool
    
    var roleName: String { isUser ? "Joe" : "Mary" }
...
/*
enum MaryDashboardSection: String, CaseIterable, Identifiable {
    case chat = "Chat"
    ...
    var icon: String {
        ...
        case .library: return "folder.fill.badge.gearshape"
...
/// Cognitive depth levels for the local M2 model
